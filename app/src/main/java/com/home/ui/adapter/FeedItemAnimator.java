...
public class FeedItemAnimator extends DefaultItemAnimator {
    ...
    public boolean animateChange(@NonNull RecyclerView.ViewHolder oldHolder,
        ...
        if (preInfo instanceof FeedItemHolderInfo) {
            ...
            animateHeartButton(holder, holder.getFeedItem());
            updateLikesCounter(holder, (int) holder.getFeedItem().getLike());
    ...
    private void animateHeartButton(final FeedAdapter.CellFeedViewHolder holder, final PostModel postModel) {
